          ...
          {destinations.map((dest, i) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-8">
                ...
                <h3 className="font-playfair text-xl sm:text-2xl font-bold text-white mb-1">{dest.name}</h3>
                <p className="text-white/70 text-xs sm:text-sm mb-3">{dest.subtitle}</p>
