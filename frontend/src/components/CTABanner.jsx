...
export default function CTABanner() {
  return (
    <section className="py-20 md:py-32 bg-[#F8FAFC]" data-testid="cta-banner">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="relative overflow-hidden rounded-3xl bg-[#1E3A8A] p-10 md:p-16 text-center"
        >
          {/* Decorative elements */}
          ...
          <div className="relative z-10">
            ...
            <h2 className="font-playfair text-3xl md:text-5xl font-semibold text-white mb-5 max-w-2xl mx-auto">
